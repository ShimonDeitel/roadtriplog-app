...
struct ContentView: View {
    ...
    @State private var editingItem: Stop?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Family Road Trip Log")
            .toolbar {
...
struct EditItemView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section("PlaceName") {
                    TextField("PlaceName", text: $field1)
            ...
            .navigationTitle(item == nil ? "Add Stop" : "Edit Stop")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var new = item ?? Stop(placeName: "", note: "")
                        new.placeName = field1
                        new.note = field2
                        onSave(new)
                        dismiss()
                    }
